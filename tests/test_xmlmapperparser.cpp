...
{
    // 测试缺少namespace的情况
    QString invalidXml = R"(<?xml version="1.0" encoding="UTF-8"?>
<mapper>
...
{
    QString malformedXml = R"(<?xml version="1.0" encoding="UTF-8"?>
...
void TestXMLMapperParser::testResultMapParsing()
{
    ...
    try {
        ...
        // 验证语句解析
        QCOMPARE(config.statements.size(), 1);
...
#include "test_xmlmapperparser.moc"